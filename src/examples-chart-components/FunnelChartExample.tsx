      ...
      <article className="my-8 w-full" id="funnel">
        <Header>
          <div className="flex flex-col mr-4 flex-1">
            ...
            <Paragraph>
              Funnel charts are used to visualize a progressive reduction of data as it passes from
              one phase to another. The chart is organized into segments that represent stages in a
              process.
            </Paragraph>
          </div>
