      ...
      <article className="my-8 w-full" id="Scatter">
        <Header>
          <div className="flex flex-col mr-4 flex-1">
            ...
            <Paragraph>
              Scatter charts are used to display the relationship between two variables. The data is
              displayed as a collection of points, each having the value of one variable determining
              the position on the horizontal axis and the value of the other variable determining
