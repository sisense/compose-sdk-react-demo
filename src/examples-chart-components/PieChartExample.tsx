      ...
      <article className="my-8 w-full" id="Pie">
        <Header>
          <div className="flex flex-col mr-4 flex-1">
            ...
            <Paragraph>
              Pie charts are used to show the proportion of a whole. Each slice of pie represents a
              category of data and the size of the slice shows the percentage of that category
