        ...
        <Header>
          <div className="flex flex-col mr-4 flex-1">
            ...
            <Paragraph>
              ...
              connected by straight line segments. It is similar to a scatter plot except that the
              measurement points are ordered (typically by their x-axis value) and joined with
              straight line segments. A line chart is often used to visualize a trend over a period
              of time, a relationship between two variables, or to show the correlation between two
              variables.
            </Paragraph>
          </div>
